...
rm -rf feeds/packages/admin/netdata/ && svn co https://github.com/openwrt/packages/trunk/admin/netdata feeds/packages/admin/netdata
...
[ ! -d mentohust ] && svn co https://github.com/1715173329/openwrt/trunk/package/ctcgfw/mentohust
